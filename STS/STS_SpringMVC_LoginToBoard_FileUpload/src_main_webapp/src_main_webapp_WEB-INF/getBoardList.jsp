...
<!-- 검색 시작 -->
		<form action="getBoardList.do" method="post">
			<table border="1" cellpadding="0" cellspacing="0" width="700">
				<tr>
					<td align="right">
					<select name="<spring:message code="message.board.list.search.condition.title"/>">
					  <c:forEach var="option" items="${conditionMap }">
							<option value="${option.value }">${option.key}
					  </c:forEach>
					</select> 
					<input name="<spring:message code="message.board.list.search.condition.content"/>" type="text" /> 
