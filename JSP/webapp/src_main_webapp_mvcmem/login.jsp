			...
			<table width="300" border="1">
				...
				<tr>
					<td align="center" width="100"><a
						href="member.mdo?cmd=modifyForm">정보 수정</a></td>
				</tr>
				<tr>
					<td align="center" width="100"><a
						href="member.mdo?cmd=deleteForm"> 회원 탈퇴</a></td>
				</tr>
				<tr>
			...
			<form action="member.mdo?cmd=loginProc" method="post">
				<table width="300" border="1">
					...
					<tr>
						...
						<td width="200">&nbsp;&nbsp; <input type="userid" name="id"
							size="20">
						</td>
					</tr>
					...
					<tr>
						<td colspan="2" align="center"><input type="submit"
							...
							value="회원가입" onclick="javascript:window.location='regForm.jsp'"></td>
					</tr>
